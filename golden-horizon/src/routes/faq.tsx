...
const faqs = [
  { cat: "البداية", q: "كيف أبدأ الاستثمار مع الراسخون كابيتال؟", a: "ابدأ بحجز استشارة مجانية عبر صفحة التواصل معنا. سيتواصل معك مستشارنا خلال 24 ساعة لتحديد أهدافك المالية ومستوى تحملك للمخاطر ثم نصمم معك محفظة استثمارية مخصصة." },
  ...
  { cat: "البداية", q: "هل أنتم شركة مرخصة؟", a: "نعم، الراسخون كابيتال شركة مرخصة ومنظمة من قِبل هيئة الأوراق المالية في دولة الإمارات العربية المتحدة، وتخضع لأعلى معايير الامتثال والشفافية المالية الدولية." },
